...
- **Standard Hosted Install:** 修改 **calico**.yml etcd 相关配置，直接创建，证书配置等参考 [手动部署 Kubernetes 文档](https://mritd.me/2017/07/21/set-up-kubernetes-ha-cluster-by-binary/#六部署-calico)
...
![calico route](https://cdn.oss.link/markdown/c44e7.jpg)
